...
# %%
# def data_load_and_process(dataset='mnist', classes=[0, 1, 2, 3], feature_reduction='resize256'):
def data_load_and_process(dataset='OrganAMNIST', classes= [0, 3, 7, 8], feature_reduction='autoencoder8'):
    ...
    # One-hot encode the labels
        # One-hot encode the labels for 6 classes
